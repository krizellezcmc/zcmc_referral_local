...
include './compare.php';
    ...
    if(count($result) > 0) { 
        ...
        foreach($result as $key => $value){
            ...
            $patId = $value['patid'];
            $FK_psPatRegisters = $value['patRegistersNo'];
        ...
        $insert->bind_param("iisssssss", $FK_psPatRegisters, $patId, $patientName, $referredDate, $referredFrom, $registryDate, $dischDiagnosis, $finalDiagnosis, $dischDate);
